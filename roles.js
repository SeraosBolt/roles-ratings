...
cells_data_array.forEach((elem, i) => {
  let player_data = {
    nome: elem[0].innerHTML,
    posicoes: elem[1].innerHTML.split(" "),
    atributos: {
      visao: Number(elem[2].innerHTML),
      um_pra_um: Number(elem[3].innerHTML),
      trab_equipe: Number(elem[4].innerHTML),
      tecnica: Number(elem[5].innerHTML),
      sem_bola: Number(elem[6].innerHTML),
      remate_longe: Number(elem[7].innerHTML),
      reflexos: Number(elem[8].innerHTML),
      primeiro_toque: Number(elem[9].innerHTML),
      posicionamento: Number(elem[10].innerHTML),
      pontape: Number(elem[11].innerHTML),
      passe: Number(elem[12].innerHTML),
      penalti: Number(elem[13].innerHTML),
      marcacao: Number(elem[14].innerHTML),
      livres: Number(elem[15].innerHTML),
      lideranca: Number(elem[16].innerHTML),
      lanca_longo: Number(elem[17].innerHTML),
      lancamento: Number(elem[18].innerHTML),
      jogo_de_mao: Number(elem[19].innerHTML),
      ind_trabalho: Number(elem[20].innerHTML),
      imprevisibilidade: Number(elem[21].innerHTML),
      finta: Number(elem[22].innerHTML),
      finalizacao: Number(elem[23].innerHTML),
      excentricidade: Number(elem[24].innerHTML),
      determinacao: Number(elem[25].innerHTML),
      desarme: Number(elem[26].innerHTML),
      decisao: Number(elem[27].innerHTML),
      cruzamento: Number(elem[28].innerHTML),
      concentracao: Number(elem[29].innerHTML),
      comunicacao: Number(elem[30].innerHTML),
      compostura: Number(elem[31].innerHTML),
      comando_area: Number(elem[32].innerHTML),
      cantos: Number(elem[33].innerHTML),
      cabeceamento: Number(elem[34].innerHTML),
      bravura: Number(elem[35].innerHTML),
      antecipacao: Number(elem[36].innerHTML),
      alcance_aereo: Number(elem[37].innerHTML),
      agressividade: Number(elem[38].innerHTML),
      tenden_socar: Number(elem[39].innerHTML),
      aceleracao: Number(elem[40].innerHTML),
      agilidade: Number(elem[41].innerHTML),
      equilibrio: Number(elem[42].innerHTML),
      impulsao: Number(elem[43].innerHTML),
      apti_fisica: Number(elem[44].innerHTML),
      velocidade: Number(elem[45].innerHTML),
      resistencia: Number(elem[46].innerHTML),
      forca: Number(elem[47].innerHTML),
      tenden_sair_bali: Number(elem[48].innerHTML),
    },
  };
...
const Striker = (player_data_array) => {
  ...
  player_data_array.forEach((elem, i) => {
    ...
    const CalcOverall = (chaves, secundarios, mentais) => {
      let best_attr =
        best_attr_chaves + best_attr_mentais + best_attr_secundarios;
    ...
    const MediaPosicao = (chaves, secundarios, mentais) => {
      ...
      let media_secundarios = secundarios  / 8;
      let media_mentais = mentais / 4;
      let media_posicao =
        (media_chaves + media_secundarios + media_mentais) / 3;
    ...
    attr_chaves =
      ...
      atributos.finta +
      atributos.primeiro_toque +
      atributos.tecnica +
      atributos.sem_bola +
      atributos.compostura +
      atributos.aceleracao;
    attr_secundarios =
      (atributos.passe +
        atributos.ind_trabalho +
        atributos.decisao +
        atributos.antecipacao +
        atributos.agilidade +
  ...
  return best_strikers_array.sort((a, b) => b.overall - a.overall);
};
const AvançadoInterior = (player_data_array) => {
  ...
  player_data_array.forEach((elem, i) => {
    ...
    attr_secundarios =
      (atributos.passe +
        atributos.remate_longe +
        atributos.imprevisibilidade +
        atributos.antecipacao +
        atributos.compostura +
        atributos.velocidade) *
      0.8;
  ...
  return best_avancado_array.sort((a, b) => b.overall - a.overall).slice(0, 7);
};
...
const Extremo = (player_data_array) => {
  ...
  return best_extremo_array.sort((a, b) => b.overall - a.overall).slice(0, 7);
};
const AvancadoSombra = (player_data_array) => {
  ...
  player_data_array.forEach((elem, i) => {
    ...
    const MediaPosicao = (chaves, secundarios, mentais) => {
      let media_chaves = chaves / 7;
      let media_secundarios = secundarios  / 9;
      let media_mentais = mentais  / 4;
      let media_posicao =
        (media_chaves + media_secundarios + media_mentais) / 3;
  ...
  return best_sombra_array.sort((a, b) => b.overall - a.overall).slice(0, 7);
};
const Mezzala = (player_data_array) => {
  ...
  return best_mezzala_array.sort((a, b) => b.media - a.media).slice(0, 14);
};
...
const Zagueiros = (player_data_array) => {
  ...
  player_data_array.forEach((elem, i) => {
    ...
    if (i > 0) {
      attr_chaves =
        atributos.cabeceamento +
        atributos.desarme +
        atributos.passe +
        atributos.agressividade +
        atributos.bravura +
        atributos.compostura +
        atributos.decisao +
  ...
  return best_zagueiros_array.sort((a, b) => b.overall - a.overall).slice(0, 7);
};
const Goleiros = (player_data_array) => {
  ...
  player_data_array.forEach((elem, i) => {
    ...
    if (i > 0) {
      attr_chaves =
        atributos.tenden_sair_bali +
        atributos.comando_area +
        atributos.pontape +
        atributos.reflexos +
        atributos.um_pra_um +
        atributos.posicionamento +
        ...
        atributos.agilidade;
      attr_secundarios =
        (atributos.alcance_aereo +
          atributos.comunicacao +
          atributos.excentricidade +
          atributos.jogo_de_mao +
          atributos.lancamento +
          atributos.passe +
          atributos.primeiro_toque +
          atributos.visao +
          atributos.aceleracao) *
  ...
  return best_goleiros_array.sort((a, b) => b.overall - a.overall).slice(0, 7);
};
...
console.log("Melhor Sombra", best_sombra);
